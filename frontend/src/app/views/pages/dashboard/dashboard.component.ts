...
export class DashboardComponent implements OnInit {
	...
	widget4_1: ({ pic: string; title: string; url: string })[];
	widget4_2: ({ pic: string; username: string; desc: string; url: string; buttonClass: string })[];
	widget4_3: ({ icon: string; title: string; url: string; value: string; valueColor: string })[];
	widget4_4: ({ pic: string; title: string; desc: string; url: string; value: string; valueColor: string })[];
